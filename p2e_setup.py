#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe --compress -b 3 -W setup.py nfc.py
...
nfc = Target(
    ...
    script="nfc.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'nfc'
    # dest_base = "nfc",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"nfc.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="nfc", level="asInvoker")).encode("utf-8")),
